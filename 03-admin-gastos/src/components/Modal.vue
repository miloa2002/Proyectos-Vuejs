...
const agregarGasto = () => {
    ...
    if([nombre, cantidad, categoria].includes("")) {
        error.value = "Todos los cmapos son obligatorios"
...
<template>
    <div class="modal">
        <div class="cerrar-modal">
            <img :src="cerrarModal" alt="Icono cerrar modal" @click="$emit('ocultar-modal')" />
        </div>
        ...
        :class='[modal.animar ? "animar" : "cerrar"]'>
            ...
            >
                ...
                <div class="campo">
                    ...
                    <input type="number" id="cantidad" placeholder="Añade la cantidad del gasto, ej. 300" :value="cantidad" @input="$emit('update:cantidad', +$event.target.value)" />
                </div>
